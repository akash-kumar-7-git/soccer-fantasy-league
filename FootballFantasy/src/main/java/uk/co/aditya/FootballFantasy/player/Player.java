package uk.co.aditya.FootballFantasy.player;
...
public class Player {
    ...
    @Column(name = "Expected Goals (xG)")
    private Double expected_goals;

    @Column(name = "Expected Assists (xAG)")
